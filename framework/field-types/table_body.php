<?php
// From fields
$from_fields = apply_filters(
    'woocommerce_catalog_enquiry_from_fields',
    array(
        "form_name" =>
        array(
            'title' => __('Name', 'woocommerce-catalog-enquiry'),
            'id' => 'name-label',
            'name' => 'form_name',
        ...
        "form_email" =>
        array(
            'title' => __('Email', 'woocommerce-catalog-enquiry'),
            'id' => 'email-label',
            'name' => 'form_email',
        ...
        "form_phone" =>
        array(
            'title' => __('Phone', 'woocommerce-catalog-enquiry'),
            'id' => 'is-phone',
            'name' => 'form_phone',
        ...
        "form_address" =>
        array(
            'title' => __('Address', 'woocommerce-catalog-enquiry'),
            'id' => 'is-address',
            'name' => 'form_address',
        ...
        "form_subject" =>
        array(
            'title' => __('Enquiry About', 'woocommerce-catalog-enquiry'),
            'id' => 'is-subject',
            'name' => 'form_subject',
        ...
        "form_comment" =>
        array(
            'title' => __('Enquiry Details', 'woocommerce-catalog-enquiry'),
            'id' => 'is-comment',
            'name' => 'form_comment',
        ...
        "form_fileupload" =>
        array(
            'title' => __('File Upload', 'woocommerce-catalog-enquiry'),
            'id' => 'is-fileupload',
        ...
        "filesize_limit" =>
        array(
            'title' => __('File Upload Size Limit ( in MB )', 'woocommerce-catalog-enquiry'),
            'id' => 'filesize-limit',
            'name' => 'filesize_limit',
...
$from_heading = apply_filters('woocommerce_catalog_enquiry_from_heading', array(
    ...
    __("Mandatory", 'woocommerce-catalog-enquiry'),
            ...
            ?>
                <tr>
                    ...
                    <td>
                        <?php
                        $ids = $value['name'];
                        if (isset($value['is_mandatory'])) {
                            echo "<label class='switch'><input class='" . $value['id'] . "' type='checkbox' name='{$setting_id}[$ids][is_mandatory]' value='" . $value['is_mandatory'] . "' " . ((isset($options[$ids]['is_mandatory']) ? $options[$ids]['is_mandatory'] == "Enable" : '') ? 'checked' : '') . "  /><span class='slider round'></span></label><br/>";
                        }
                        ?>
                    </td>
                    <td>
