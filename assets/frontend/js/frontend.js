jQuery(document).ready(function ($) {
  ...
  $("#woocommerce-submit-enquiry").on("click", function () {
    ...
    if (
      typeof catalog_enquiry_front.settings_gen.form_captcha != "undefined" &&
      typeof catalog_enquiry_front.settings_gen.form_captcha.is_enable !=
        "undefined" &&
      catalog_enquiry_front.settings_gen.form_captcha.is_enable !== null &&
      catalog_enquiry_front.settings_gen.form_captcha.is_enable == "Enable"
    ) {
    ...
    if (
      catalog_enquiry_front.settings_gen.form_phone.is_mandatory == "Enable" &&
      (phone == "" || phone == " ")
    ) {
      document.getElementById("msg-for-enquiry-error").innerHTML =
        catalog_enquiry_front.error_levels.phone_required;
      document.getElementById("woocommerce-user-phone").focus();
      return false;
    }
    ...
    if (!regex.test(phone)) {
      document.getElementById("msg-for-enquiry-error").innerHTML =
        catalog_enquiry_front.error_levels.valid_phone_required;
      document.getElementById("woocommerce-user-phone").focus();
      return false;
    }

    if (
      catalog_enquiry_front.settings_gen.form_address.is_mandatory ==
        "Enable" &&
      (address == "" || address == " ")
    ) {
      document.getElementById("msg-for-enquiry-error").innerHTML =
        catalog_enquiry_front.error_levels.address_required;
      document.getElementById("woocommerce-user-address").focus();
      return false;
    }

    if (
      catalog_enquiry_front.settings_gen.form_comment.is_mandatory ==
        "Enable" &&
      (comment == "" || comment == " ")
    ) {
      document.getElementById("msg-for-enquiry-error").innerHTML =
        catalog_enquiry_front.error_levels.comment_required;
      document.getElementById("woocommerce-user-comment").focus();
      return false;
    }

    if (
      catalog_enquiry_front.settings_gen.form_fileupload.is_mandatory ==
        "Enable" &&
      (document.getElementById("woocommerce-user-fileupload").value == "" ||
        document.getElementById("woocommerce-user-fileupload").value == " ")
    ) {
      document.getElementById("msg-for-enquiry-error").innerHTML =
        catalog_enquiry_front.error_levels.upload_required;
      document.getElementById("woocommerce-user-fileupload").focus();
      return false;
    }
      ...
      jQuery.ajax({
        ...
        success: function (response) {
          ...
          if (response.status == 1) {
            ...
            if (
              typeof catalog_enquiry_front.settings.is_page_redirect !=
                "undefined" &&
              catalog_enquiry_front.settings_gen.is_page_redirect !== null
            ) {
