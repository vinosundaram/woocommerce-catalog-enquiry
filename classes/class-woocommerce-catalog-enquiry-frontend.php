                    ...
                    case 2:
                        ...
                        if (isset($settings['is_enable_out_of_stock']) && $settings['is_enable_out_of_stock'] == "Enable") {
                            if (!$product->managing_stock() && !$product->is_in_stock()) {
                                $pro_link = sprintf(
                                    '<a id="%s" href="%s" data-quantity="%s" class="%s" %s>%s</a>',
...
?>
        <div id="woocommerce-catalog" name="woocommerce_catalog">
            ...
            ?>
                    <br />
                    <button class="woocommerce-catalog-enquiry-btn button woocommerce-catalog-enquiry-custom-button-enquiry <?php if ($settings_buttons && isset($settings_buttons['is_button']) && $settings_buttons['is_button'] == 'Enable') echo 'custom_enquiry_buttons_css_new';
                                                                                                                            else echo ''; ?>" href="#responsive"><?php echo esc_html($enquiry_button_text); ?></button>
                <?php
                ...
                ?>
                <br />
                <button class="woocommerce-catalog-enquiry-btn button demo btn btn-primary btn-large <?php if ($settings_buttons && isset($settings_buttons['is_button']) && $settings_buttons['is_button'] == 'Enable') echo 'custom_enquiry_buttons_css_new';
                                                                                                        else echo ''; ?>" style="margin-top:15px;" href="#responsive"><?php echo esc_html($enquiry_button_text); ?></button>
            <?php
            } ?>
    ...
    ?>
        <div id="woocommerce-catalog" name="woocommerce_catalog">
            ...
            ?>
                    ...
                    ?>
                        <button class="woocommerce-catalog-enquiry-btn button demo btn btn-primary btn-large <?php if ($settings_buttons && isset($settings_buttons['is_button']) && $settings_buttons['is_button'] == 'Enable') echo 'custom_enquiry_buttons_css_new';
                                                                                                                else echo ''; ?>" style="margin-top:15px;" href="#responsive"><?php esc_html_e('Send an enquiry', 'woocommerce-catalog-enquiry') ?></button>
                    <?php
                    }
                } else {
                    $product_object = wc_get_product($productid);
...
<?php
    ...
    function frontend_scripts()
    {
        ...
        if (isset($settings['is_enable']) && $settings['is_enable'] == "Enable") {
            ...
            $error_levels['phone_required'] = __('Phone Number is required field', 'woocommerce-catalog-enquiry');
            $error_levels['valid_phone_required'] = __('Please Enter Valid Phone Number', 'woocommerce-catalog-enquiry');
            $error_levels['address_required'] = __('Address is required field', 'woocommerce-catalog-enquiry');
            $error_levels['comment_required'] = __('Message is required field', 'woocommerce-catalog-enquiry');
            $error_levels['upload_required'] = __('Upload File is required field', 'woocommerce-catalog-enquiry');
            ...
            wp_localize_script(
                ...
                apply_filters('woocommerce_catalog_enquiry_localize_script_data', array(
